...
class Image extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'preload_preview',
            array(
                'label'        => __('Preload Preview','auxin-elements' ),
                'description'  => __('Specifies what should be displayed during pre-loading the image.','auxin-elements' ),
                'type'         => Controls_Manager::SELECT,
                'options'      => array(
                    'no'        => __('None', 'auxin-elements' ),
                    'yes'       => __('Blured image preview', 'auxin-elements' ),
                    'progress'  => __('In-progress animation', 'auxin-elements' )
                ),
                'return_value' => 'yes',
                'default'      => 'yes',
                'condition'    => array(
